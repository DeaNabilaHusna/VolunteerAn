...
use App\Http\Controllers\DashboardVolunteerController as ControllersDashboardVolunteerController;
use App\Http\Controllers\RegistrasiRelawanController;
...
Route::get('/detailevent/{id}', function ($id) {
...
Route::post('/regisrelawan', [RegistrasiRelawanController::class, 'store']);
...
Route::get('/formregisevent/{id}', function ($id) {
